...
contract Tempos is ERC721Enumerable, Ownable {
    ...
    // ======// Constructor & Struct //======
    constructor() ERC721("TEMPOS", "TPS") {
    }
    
    // ======// Functions //======
    
    // Max amonut wallet can mint per transaction
    ...
    function mint(uint256 _numberOfTokens) public payable {
        ...
        require(_numberOfTokens > 0, "You cannot mint 0 TEMPOS, please increase to 1 or more");
        require(_numberOfTokens <= getMaxAmount(), "You are not allowed to mint this many TEMPOS at once.");
        ...
        if(onlyWhitelisted == true) {
            ...
            require(msg.value >= PRICE * _numberOfTokens, "Not enough ETH to buy a TEMPOS");
        }
